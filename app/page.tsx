    ...
    <main className="flex flex-col w-screen text-center text-[#fff]">
      ...
      <div className="min-h-screen relative mb-16 border-t-2 border-vvm-pink">
        ...
        <div id="home-service-container" className="grid grid-cols-1 grid-rows-4 lg:grid-cols-2 lg:grid-rows-2 max-lg:gap-y-10 text-left mb-10 lg:mt-10 2xl:mt-14">
          <div id="service1" className="max-w-96 border-b-2 lg:border-r-2 border-white pb-10 mx-auto service-item">
          ...
          <div id="service2" className="max-w-96 border-b-2 border-white pb-10 mx-auto service-item">
          ...
          <div id="service3" className="max-w-96 max-lg:border-b-2 lg:border-r-2 border-white pb-10 mx-auto lg:py-5 service-item">
          ...
          <div id="service4" className="max-w-96 pb-10 mx-auto lg:py-5 service-item">

  ...
  return (
    ...
    <main className="flex flex-col w-screen text-center text-white">
        ...
        <div className="min-h-screen relative">
            <Image src={'/images/ben-collins-SpDOwp6PnBs-unsplash.jpg'} alt="camera 1" style={{objectFit:"cover"}} className="-z-10 opacity-30" fill priority />
            <div className="flex flex-col pl-10 pt-64">
        ...
        <div className="min-h-screen relative mb-16 border-t-2 border-white">
            <div className="flex flex-col items-center gap-y-2 lg:pt-32">
                <h1 className="max-lg:mt-10 text-vvm-lightblue">Inspire, Engage, and Impress</h1>
                <p className="mb-14 md:w-3/5 mx-auto text-center w-3/4 lg:text-2xl">Hook your audience, engage their senses, and leave an unforgettable impression with captivating video productions that elevate your brand.</p>
                ...
                <div id="home-service-container" className="grid grid-cols-1 grid-rows-4 md:grid-cols-2 md:grid-rows-2 max-lg:gap-y-10 md:max-lg:gap-x-4 lg:gap-y-16 lg:gap-x-16 text-left mb-10 lg:mt-10 2xl:mt-14 md:pl-5 md:pr-9">
                    ...
                    <div id="service1" className="max-w-96 max-md:border-b-2 border-white pb-10 mx-auto service-item flex flex-col items-center md:bg-custom-gray md:rounded-xl">
                    ...
                    <div id="service2" className="max-w-96 max-md:border-b-2 border-white pb-10 mx-auto service-item flex flex-col items-center md:bg-custom-gray md:rounded-xl">
                        ...
                        <p className="md:text-center lg:text-2xl">High-energy videos designed to build excitement around events, launches, or products / services</p>
                    </div>

                    <div id="service3" className="max-w-96 max-md:border-b-2  border-white pb-10 mx-auto  service-item flex flex-col items-center md:bg-custom-gray md:rounded-xl">
                    ...
                    <div id="service4" className="max-w-96 pb-10 mx-auto  service-item flex flex-col items-center md:bg-custom-gray md:rounded-xl">

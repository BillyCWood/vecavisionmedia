...
export default function Home() {
  return (
    ...
    <main className="flex flex-col w-screen text-center text-[#fff]">
      ...
      <div className="hidden min-h-screen max-h-screen lg:max-2xl:flex flex-col justify-evenly border-b-2 my-14 border-vvm-blue">
      ...
      <div className="hidden min-h-screen max-h-screen 2xl:flex justify-evenly border-b-2 my-14 border-vvm-blue">
        ...
        <div className="max-lg:mx-auto w-1/2 lg:w-1/4 lg:mt-80 gap-y-2 flex flex-col">
          <h1 className="font-bold text-2xl text-vvm-lightblue text-left">Inspire, Engage, and Impress</h1>

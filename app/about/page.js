...
export default function About(){
    return (
        <main className="text-center relative bg-[#000]">
            ...
            <div className="pt-10 pb-10 border-b border-vvm-teal">
                ...
                <p className="px-6 sm:px-16 lg:px-32 2xl:px-96 mb-6 max-lg:text-left">Driven by the belief that authentic storytelling and high-quality visuals have the power to transform businesses and captivate audiences, Veca Vision Media exists to put that power into the hands of businesses by providing exceptional video marketing and advertising services.</p>
                <p className="px-6">“Using video to connect with a prospect is so much more than a cold call. It humanized the selling process” -Jill Rowley</p>
            </div>
            ...
            <div className="pt-10 pb-10 border-b border-vvm-blue">
                ...
                <p className="px-6 sm:px-24 lg:px-32 2xl:px-96 mb-6 max-lg:text-left">At Veca Vision Media, our mission is to empower businesses and brands to connect with their audiences through innovative and captivating visual storytelling. We are committed to delivering high-quality video production services that exceed our clients' expectations, driven by creativity, professionalism, and a relentless pursuit of excellence.</p>
            </div>
            ...
            <div className="pt-10 pb-10 border-b border-vvm-pink">
                ...
                <p className="px-6 sm:px-24 lg:px-32 2xl:px-96 mb-6 max-lg:text-left">

    ...
    return (
        <main className="text-center bg-[#000]">
            ...
            <div className="pt-10 pb-10 border-b border-vvm-blue">
                ...
                <p className="px-6 sm:px-24 lg:px-32 2xl:px-96 mb-6">At Veca Vision Media, our mission is to empower businesses and brands to connect with their audiences through innovative and captivating visual storytelling. We are committed to delivering high-quality video production services that exceed our clients' expectations, driven by creativity, professionalism, and a relentless pursuit of excellence.</p>
            </div>
            ...
            <div className="pt-10 pb-10 border-b border-vvm-pink">
                ...
                <p className="px-6 sm:px-24 lg:px-32 2xl:px-96 mb-6">

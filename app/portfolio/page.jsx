...
export default function Portfolio() {
  ...
  return (
    <main className="bg-[#000] min-h-screen">
        ...
        {/* <div className="mt-10 py-2 w-96 mx-auto lg:hidden items-center">
        ...
        <div className="mt-10 py-2 w-96 mx-auto lg:hidden">
            <button className={`flex w-56 mx-auto py-4 z-50 bg-white text-black border-[2px] border-white hover:text-white hover:bg-[#aaa] justify-center transition-all duration-300 ease-linear ${show ? 'rounded-t-3xl': 'rounded-3xl'}`} onClick={()=> {setShow(!show)}}>Search by topic</button>

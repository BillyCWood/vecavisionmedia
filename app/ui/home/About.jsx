...
export default function About() {
    ...
    return(
        ...
        <div className='lg:hidden max-w-[1440px] mx-auto'>
            ...
            <div className='w-fit mx-auto my-5 border-[1px] border-white/50 service-item'>
                <Image src={"/images/VVM-Jaiden_head.jpg"} width={300} height={300} />
            </div>
        ...
        <div className='max-lg:hidden flex mx-auto gap-x-10'>
            <div className='w-[300px] h-[300px] border-[1px] border-white/50 z-[2] service-item'>
                <Image src={"/images/VVM-Jaiden_head.jpg"} width={400} height={400} />
            </div>

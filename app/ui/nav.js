...
export default function Nav() {
    ...
    return(
        <div>
            <div className="hidden lg:flex z-10 sticky top-0 bg-[#000] border-b border-white justify-evenly items-center lg:px-24 xl:px-72">
            ...
            <div className="flex lg:hidden z-10 sticky top-0 bg-[#000] border-b border-white px-6 justify-between">

    ...
    <div className='bg-custom-gray py-10 relative border-t-2 border-white'>
        ...
        <div className="slide-container w-full inline-flex flex-nowrap">
            <ul id="top-slide-1" className="image-container flex items-center justify-center">
                ...
                <li><Image src={'/logos/MontanaFlavor.webp'} width={128} height={1} alt="Montana Flavor" className="carousel-logo" /></li>
                <li><Image src={'/logos/mountain_italian_ice.webp'} width={128} height={1} alt="Mountain Italian Ice" className="carousel-logo" /></li>
        ...
        <div className="slide-container w-full inline-flex flex-nowrap mt-20">
            <ul id="bottom-slide-1" className="image-container flex items-center justify-center">
                <li><Image src={'/logos/Tarantinos-logo-small.webp'} width={128} height={1} alt="Montana Fence" className="carousel-logo" /></li>
                <li><Image src={'/logos/savage_logo.webp'} width={128} height={1} alt="Montana Fence" className="carousel-logo bg-white" /></li>
                <li><Image src={'/logos/MontanaFenceLogo.webp'} width={128} height={1} alt="Montana Fence" className="carousel-logo" /></li>
                <li><Image src={'/logos/EvolveLogo.png'} width={128} height={1} alt="Evolve Hair Design" className="carousel-logo" /></li>
                <li><Image src={'/logos/tja_logo.webp'} width={128} height={1} alt="Montana Fence" className="carousel-logo" /></li>
                <li><Image src={'/logos/CraftedAesthetics.png'} width={128} height={1} alt="Crafted Aesthetics and Wellness" className="carousel-logo bg-white" /></li>
            </ul>

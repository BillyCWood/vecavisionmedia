...
export default function Video({title, thumbnail, src, description}) {
    ...
    return(
        <div className="mb-10">
            ...
            <div className="group rounded-2xl grid place-items-center [grid-template-areas:'stack']" onClick={() => setIsVisible('absolute')}>
            ...
            <div className={`${isVisible} w-full h-full left-0 top-0 pt-60 px-4 bg-custom-gray bg-opacity-85 z-10`}>
                <div className="flex flex-col gap-y-6 w-2/3 mx-auto">
                    ...
                    <iframe className={`rounded-2xl aspect-video`} src={src} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerpolicy="strict-origin-when-cross-origin"></iframe>
                </div>
            </div>

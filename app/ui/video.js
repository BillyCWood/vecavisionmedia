...
export default function Video({title, thumbnail, src, description}) {
    ...
    return(
        <div className="mb-10">
            ...
            <div className="rounded-2xl hover:z-0 hover:bg-vvm-pink hover:opacity-60 ease-in-out duration-200 hover:cursor-pointer" onClick={() => setIsVisible('absolute')}>
                <img className="rounded-2xl aspect-auto" src={thumbnail} />
            </div>

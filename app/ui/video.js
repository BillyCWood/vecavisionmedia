    ...
    return(
        <div className="mb-10">
            ...
            <div className="group rounded-2xl grid place-items-center [grid-template-areas:'stack'] overflow-hidden max-h-[720px] bg-vvm-pink" onClick={() => setIsVisible('fixed')}>
                ...
                <p className="hidden lg:block opacity-0 group-hover:opacity-100 group-hover:z-[1] ease-in-out duration-200 px-6 xl:px-28 [grid-area:stack] text-left">{description}</p>
            </div>
        
            <div className={`${isVisible} w-full h-screen left-0 top-14 pt-60 px-4 bg-custom-gray bg-opacity-85 z-[1]`}>
